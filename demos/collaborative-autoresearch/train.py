...
def train():
    ...
    lr          = 2.5e-2    # NEW BEST: 2.5e-2 with beta1=0.82 gives 2.255 mean (24 seeds)
    ...
    optimizer = torch.optim.AdamW(
        model.parameters(),
        lr=lr,
        betas=(0.82, 0.95),  # NEW BEST: 0.82 beats 0.80 by ~0.013 (24 seeds)
        weight_decay=0.2,
    )
    ...
    for x, y in loader:
        ...
        loss.backward()
        torch.nn.utils.clip_grad_norm_(model.parameters(), 0.8)  # sweet spot confirmed with proj_std=0.09
