/**
 * Minimal RS decode wrapper for the Worker/resolver.
 * Inlines the GF(256) arithmetic — no external dependencies.
...
/**
 * Reconstruct k original data buffers from a partial chunk set.
 * chunks[i] = null means chunk i is unavailable.
 * First k entries are data chunks; remaining are parity chunks.
 */
